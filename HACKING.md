...
hidden if the `sabatdaq_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `sabatdaq_DEVELOPER_MODE` to the configure
...
Runs the executable target `sabatdaq_exe`.
